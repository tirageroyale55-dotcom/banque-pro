...
export default function Produits({ isDesktop = false }) {
  ...
  return (
    <div className={`bper-page-global-wrapper ${isDesktop ? "" : "page-content"}`}>
      <div style={{ maxWidth: "1100px", margin: "0 auto", fontFamily: "'Segoe UI', sans-serif" }}>
        ...
        {currentView === "offres" && (
          <>
            <h2 className="cards-title main-page-title" style={{ color: "#004f52", fontSize: "2rem", marginBottom: "25px" }}>
            ...
            <div className="account-card bper-sav-card" style={{ background: "#fff", padding: "25px", borderRadius: "20px", boxShadow: "0 4px 6px -1px rgba(0,0,0,0.05)" }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "15px" }}>
                <div>
                  <h3 className="bper-sav-title" style={{ color: "#004f52", margin: "0 0 8px 0", fontSize: "1.3rem" }}>Livret d'Épargne BPER Privilège</h3>
                  <p className="bper-sav-text" style={{ color: "#64748b", margin: 0, fontSize: "0.95rem" }}>Optimisez et sécurisez vos économies avec un taux d'intérêt annuel brut de 3,50% garanti.</p>
                </div>
        ...
        {currentView === "avantages" && (
          <div className="bper-advantages-block" style={{ background: "white", padding: "40px", borderRadius: "32px", boxShadow: "0 20px 25px -5px rgba(0,0,0,0.05)" }}>
            <button className="bper-back-btn" onClick={() => setCurrentView("offres")} style={{ background: "none", border: "none", color: "#004f52", cursor: "pointer", fontWeight: "600", marginBottom: "20px" }}>
              <i className="fas fa-arrow-left"></i> Retour aux produits
            </button>

            <h2 className="bper-adv-title" style={{ color: "#004f52", fontSize: "2.2rem", marginTop: 0, marginBottom: "15px" }}>Pourquoi choisir le Prêt Personnel BPER Banca ?</h2>
            <p className="bper-adv-subtitle" style={{ color: "#64748b", fontSize: "1.1rem", lineHeight: "1.6", maxWidth: "800px", marginBottom: "40px" }}>
            ...
            <div className="bper-adv-grid" style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: "25px", marginBottom: "5px" }}>
              <div className="bper-adv-card" style={{ background: "#f8fafc", padding: "25px", borderRadius: "16px", borderTop: "4px solid #004f52" }}>
              ...
              <div className="bper-adv-card" style={{ background: "#f8fafc", padding: "25px", borderRadius: "16px", borderTop: "4px solid #059669" }}>
              ...
              <div className="bper-adv-card" style={{ background: "#f8fafc", padding: "25px", borderRadius: "16px", borderTop: "4px solid #eab308" }}>
            ...
            {/* TABLEAU COMPARATIF BANCAIRE */}
            <div className="bper-table-section" style={{ marginTop: "50px", marginBottom: "40px" }}>
              <h3 className="bper-table-title" style={{ color: "#004f52", marginBottom: "20px" }}>BPER face aux autres institutions financières</h3>
              <div style={{ overflowX: "auto" }}>
                <table className="bper-comparison-table" style={{ width: "100%", borderCollapse: "collapse", textAlign: "left", fontSize: "0.95rem" }}>
                  <thead>
                  ...
                  <tbody>
                    ...
                    <tr style={{ borderBottom: "1px solid #e2e8f0" }}>
                      <td style={{ padding: "15px", fontWeight: "600" }}>Frais de dossier</td>
                    ...
                    <tr style={{ borderBottom: "1px solid #e2e8f0" }}>
                      <td style={{ padding: "15px", fontWeight: "600" }}>Remboursement anticipé</td>
            ...
            <div className="bper-cta-banner" style={{ textAlign: "center", background: "#004f52", padding: "35px", borderRadius: "20px", color: "white" }}>
