...
export default function Dashboard() {
  ...
  // Gestion du scroll pour la barre mobile
  useEffect(() => {
  ...
  // --- PRÉPARATION DES DONNÉES GRAPHIQUES (CORRIGÉE) ---
  ...
  const chartOptions = {
    ...
    plugins: {
      ...
      tooltip: { backgroundColor: "#0b5c5b", padding: 12 },
    },
    scales: {
      ...
      <div className="bank-app bper-desktop-interface">
        ...
        <main className="bper-main-content">
          ...
          <div className="bper-scroll-zone">
              ...
              <div className="bper-dashboard-container">
                ...
                <section className="bper-hero-card-white">
                  <div className="bper-balance-block">
                    <p className="bper-label-green">Solde disponible</p>
                    <h1 className="bper-amount-green">{formatBper(data.balance)} €</h1>
                    {showIban && <p className="bper-iban-display" style={{fontFamily: 'monospace', marginTop: '10px', color: '#64748b'}}>{data.iban}</p>}
                  </div>
                  <div className="bper-actions-row-under">
                    ...
                    <button className="bper-pill-green active" onClick={() => navigate("/virement-international")}>Virement international</button>
                    <button className="bper-pill-green">Ma carte virtuelle</button>
                  </div>
                </section>

                {/* BLOC GRAPHIQUE */}
                <section className="bper-history-block-white" style={{ marginBottom: '25px' }}>
                  <div className="bper-history-header-green">
                    <span className="bper-menu-symbol-green">📈</span>
                    <h3>Analyse des entrées et sorties</h3>
                  </div>
                ...
                <section className="bper-history-block-white">
                  ...
                  <div className="bper-transactions-table-green">
                    {rawTransactions.slice(0, 10).map((tr, i) => (
            ...
            {activeTab === "cards" && <div className="bper-dashboard-container"><BankCard card={card} /></div>}
