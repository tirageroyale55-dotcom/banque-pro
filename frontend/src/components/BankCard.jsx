    ...
    >
      <div className="card-inner">
        ...
        >
          ...
          {/* PUCE EMV : Style Vrai Guichet (Partout) */}
          ...
          <div className="card-footer">
            ...
            {/* LOGO MASTERCARD : TAILLE EXACTE (Uniquement ici) */}
        ...
        {/* --- FACE ARRIÈRE (VERSO) : Pas de Mastercard ici --- */}
